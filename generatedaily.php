...
<body>
    <div class="container">
        ...
        <table id="tableResult"> 
            <thead>
                <tr>
                    <td class="xl89" width="73" style="width:60pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">日期<br style="mso-data-placement:same-cell;"/>
                    Date</td>
                    <td class="xl89" width="94" style="border-left:none;width:71pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">部门<br style="mso-data-placement:same-cell;"/>
                    Department</td>
                    <td class="xl89" width="196" style="border-left:none;width:147pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">存在的问题及对策 <br style="mso-data-placement:same-cell;"/>
                    Existing Problems &amp; Solutions</td>
                    <td class="xl89" width="261" style="border-left:none;width:196pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">工作任务<br style="mso-data-placement:same-cell;"/>
                    Tasks</td>
                    <td class="xl89" width="193" style="border-left:none;width:145pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">完成情况或所需资源<br style="mso-data-placement:same-cell;"/>
                    Progress/Required Resources</td>
                    <td class="xl89" width="138" style="border-left:none;width:104pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">计划完成时间<br style="mso-data-placement:same-cell;"/>
                    Date of Planned Completion</td>
                    <td class="xl89" width="162" style="border-left:none;width:122pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">经办人<br style="mso-data-placement:same-cell;"/>
                    Person in Charge</td>
                    <td class="xl89" width="114" style="border-left:none;width:86pt;background:#B7B7B7;color:black;
        font-weight:700;border:.5pt solid windowtext;font-size:13px;font-family:arial;vertical-align:top;">主管领导<br style="mso-data-placement:same-cell;"/>
                    Leader</td>
...
<script type="text/javascript">
        ...
        if(status != '') {
            if(status.length > 0) {
                for(var i=0; i<status.length;i++) {
                    ...
                    if(status[i].toLowerCase() == 'ongoing' || status[i].toLowerCase() == '(ongoing)' || status[i].toLowerCase() == '(in progress)' || status[i].toLowerCase() == 'in progress' || status[i].toLowerCase() == 'todo' || status[i].toLowerCase() == '(to do)' || status[i].toLowerCase() == '(on going)' || status[i].toLowerCase() == '(todo)') {
                        dateStr += '<?= date("Y-m-d", time()+86400); ?><br style="mso-data-placement:same-cell;"/> ';
                    }
                    else { 
                        dateStr += '<?= date("Y-m-d"); ?><br style="mso-data-placement:same-cell;"/> ';
                    }
                }
            }
            else {
                tempStr += status[0];
                if(status[i].toLowerCase() == 'ongoing' || status[i].toLowerCase() == '(ongoing)' || status[i].toLowerCase() == '(in progress)' || status[i].toLowerCase() == 'in progress' || status[i].toLowerCase() == 'todo' || status[i].toLowerCase() == '(to do)' || status[i].toLowerCase() == '(on going)') {
                    dateStr += '<?= date("Y-m-d", time()+86400); ?><br style="mso-data-placement:same-cell;"/> ';
                }
                else {
                    dateStr += '<?= date("Y-m-d"); ?><br style="mso-data-placement:same-cell;"/> ';
    ...
    $(document).ready(function() {
        ...
        $('#formSubmit').off().on('click', function(e){
            ...
            var statuses = ['done', 'completed', 'ongoing', '(on going)', 'on-going', 'todo', 'to do', '(done)', '(ongoing)', 'in progress', '(in progress)', '(todo)', '(to do)']; 
            ...
            if(tasks == '') {
                ...
                for(var i=0; i<items.length;i++) {
                    ...
                    if(items[i].includes('tomorrow') || items[i].includes('next')) {
                        ...
                        itemsStatus = [];
                        tableStr += task('Tomorrow');
                    }
                    else if(items[i].includes('today')) {
                        tableStr += task('Today');
                    }
                    else {
